...
public class semester7 extends Fragment {
    private papersAdapter mySem7PaperAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseRecyclerOptions<paperInfo> sem2Questionpapers = new FirebaseRecyclerOptions.Builder<paperInfo>().setQuery(FirebaseDatabase.
                getInstance().getReference().child("papers").child("semester7"), paperInfo.class).build();
        ...
        mySem7PaperAdapter = new papersAdapter(sem2Questionpapers);
        papersRecyclerView.setAdapter(mySem7PaperAdapter);
        return rootView;
    ...
    public void onStart() {
        super.onStart();
        mySem7PaperAdapter.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        mySem7PaperAdapter.stopListening();
    }

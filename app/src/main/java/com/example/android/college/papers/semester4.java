...
public class semester4 extends Fragment {

    private papersAdapter mySem4PaperAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseRecyclerOptions<paperInfo> sem2Questionpapers = new FirebaseRecyclerOptions.Builder<paperInfo>().setQuery(FirebaseDatabase.
                getInstance().getReference().child("papers").child("semester4"), paperInfo.class).build();
        ...
        mySem4PaperAdapter = new papersAdapter(sem2Questionpapers);
        papersRecyclerView.setAdapter(mySem4PaperAdapter);
        return rootView;
    ...
    public void onStart() {
        super.onStart();
        mySem4PaperAdapter.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        mySem4PaperAdapter.stopListening();
    }

...
public class semester5 extends Fragment {
    private papersAdapter mySem5PaperAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseRecyclerOptions<paperInfo> sem2Questionpapers = new FirebaseRecyclerOptions.Builder<paperInfo>().setQuery(FirebaseDatabase.
                getInstance().getReference().child("papers").child("semester5"), paperInfo.class).build();
        ...
        mySem5PaperAdapter = new papersAdapter(sem2Questionpapers);
        papersRecyclerView.setAdapter(mySem5PaperAdapter);
        return rootView;
    ...
    public void onStart() {
        super.onStart();
        mySem5PaperAdapter.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        mySem5PaperAdapter.stopListening();
    }

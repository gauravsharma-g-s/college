...
public class semester3 extends Fragment {
    private papersAdapter mySem3PaperAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseRecyclerOptions<paperInfo> sem2Questionpapers = new FirebaseRecyclerOptions.Builder<paperInfo>().setQuery(FirebaseDatabase.
                getInstance().getReference().child("papers").child("semester3"), paperInfo.class).build();
        ...
        mySem3PaperAdapter = new papersAdapter(sem2Questionpapers);
        papersRecyclerView.setAdapter(mySem3PaperAdapter);
        return rootView;
    ...
    public void onStart() {
        super.onStart();
        mySem3PaperAdapter.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        mySem3PaperAdapter.stopListening();
    }

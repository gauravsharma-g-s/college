...
public class semester6 extends Fragment {

    private papersAdapter mySem6PaperAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseRecyclerOptions<paperInfo> sem2Questionpapers = new FirebaseRecyclerOptions.Builder<paperInfo>().setQuery(FirebaseDatabase.
                getInstance().getReference().child("papers").child("semester6"), paperInfo.class).build();
        ...
        mySem6PaperAdapter = new papersAdapter(sem2Questionpapers);
        papersRecyclerView.setAdapter(mySem6PaperAdapter);
        return rootView;
    ...
    public void onStart() {
        super.onStart();
        mySem6PaperAdapter.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        mySem6PaperAdapter.stopListening();
    }
